...
def get_current_matche():
    try:
        ...
        messagebox.showwarning("提示", "当前没有进行中的比赛")
        return
...
def file_list():
    global main_view_var, others_view_var, red_team_var, blue_team_var, resolution_combobox
    files = []
...
others_view_check.grid(row=1, column=1, padx=8, pady=0, sticky="ew")
